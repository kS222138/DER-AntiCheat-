...
var client: DERNetworkClient  # 添加 client 变量
...
func _ready():
    ...
    # Create network client for heartbeat and queue examples / 创建网络客户端用于心跳和队列示例
